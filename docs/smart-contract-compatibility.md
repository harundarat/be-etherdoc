...
| Commit | `175b902733794f9466ef73dc97f69a074b4b80c8` |
...
Verifikasi baseline pada 25 Juli 2026:

```text
forge build
forge test -vv

13 suites; 114 passed; 0 failed; 2 skipped
```

Dua test yang dilewati adalah fork test Mantle/Ink yang membutuhkan RPC. Source contract,
...
| --- | --- | ---: | ---: | --- | --- |
| Canonical source | Mantle Sepolia | `5003` | `8236463271206331221` | `0xFd33fd627017fEf041445FC19a2B6521C9778f86` | `0x22bdEdEa0beBdD7CfFC95bA53826E55afFE9DE04` |
| Destination | Ink Sepolia | `763373` | `9763904284804119144` | `0x17fCda531D8E43B4e2a2A2492FBcd4507a1685A1` | `0x3423C922911956b1Ccbc2b5d4f38216a6f4299b4` |
...
`EtherdocSender` adalah registry canonical dan endpoint outbound pada Mantle. `EtherdocReceiver`
adalah projection receipt pada Ink dan bukan sumber kebenaran alternatif.
...
Receiver mengikat envelope pada selector Mantle, sender address tepercaya, dan `sourceChainId=5003`;
pesan diproses idempotent berdasarkan message ID dan versi.
